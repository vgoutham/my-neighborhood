...
var ChartContainer = module.exports = React.createClass({
  componentDidMount: function() {
    ...
    //get data from res
    var ageDemographics = datax['Demographics:demographics'].response[0].pages[0].page[2].tables[0].table[1].data[0].attribute;
    
    var dataArr = [];
    for (var i = 0; i < ageDemographics.length; i++) {
      dataArr.push({
        name: ageDemographics[i].name[0],
        val: Math.round(ageDemographics[i].value[0]._ * 100)
      });
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////
    //draw initial canvas
